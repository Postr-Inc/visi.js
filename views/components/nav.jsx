function nav() {
    ...
    return (
        <div className="navbar bg-base-100 w-full h-16  ">
            <div className="navbar-start">
                ...
                <a className="normal-case justify-center xl:justify-start  font-bold ml-12 "> <img src={logo} className="h-7 w-7 rounded" alt="logo" 
